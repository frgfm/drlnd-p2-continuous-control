...
class Agent():
    ...
    def __init__(self, state_size, action_size, train=False, device=None, buffer_size=1e5, batch_size=128,
                 lr=5e-4, lr_steps=100000, lr_gamma=0.5, gamma=0.9, tau=5e-4,
                 noise_mean=0, noise_theta=0.15, noise_sigma=0.12,
                 grad_clip=1.0):
...
class OUNoise:
    ...
    def __init__(self, size, mu=0., theta=0.15, sigma=0.12):
